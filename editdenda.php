...
<div class="menu">
	...
	<div class="content"> <h3>Edit Denda</h3> <br>
	<form method="post" action="">
	<?php
include "koneksi.php";
$kode=$_GET['kd'];
$edit=mysql_query("SELECT*FROM Denda WHERE Kddenda='$kode'");
$data=mysql_fetch_array($edit);
	echo"<table>
	<tr>
		<td>Kode Denda</td>  <td><input type='text' name='a' class='ip' value='".$data['Kddenda']. "'><br></td></tr>
        <tr><td>Jenis Denda</td> <td><input type='text' name='b' class='ip' value='".$data['Jns_denda']. "'><br></td></tr>
...
if(isset($_POST['update'])){
	...
	$update=mysql_query("UPDATE Denda SET Kddenda='$a',Jns_denda='$b',Denda='$c' WHERE Kddenda='$a'");
if($update){
	echo "<font color='red'><h2>Data berhasil di rubah</h2></font> <a href='denda.php'><h2>kembali<h2></a>";
}else{
	echo "Data Gagal Di Rubah <a href='denda.php'>kembali</a>";
}
}
	?>
	 </div>
