...
<div class="menu">
	...
	<table>
	<tr>
		<td>Kode Kembali</td>  <td><input type="text" name="a" class="ip"><br></td></tr>
        <tr><td>Kode Pinjam</td> <td><input type="text" name="b" class="ip" ><br></td></tr>
		<tr><td>Denda</td> <td><input type="text" name="c" class="ip" ><br></td></tr>
		<tr><td><input type="submit" name="kirim" value="simpan" style="width: 70px; height: 30px;"><br></td>
		<td><a href="kembalian.php"><input type="button" name="" value="Kembali" style="width: 70px; height: 30px;"></a></td></tr>
	</table>
	</form>
	<?php
include "koneksi.php";
