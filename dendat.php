...
<div class="menu">
	...
	<table>
	<tr>
		<td>Kode Denda</td>  <td><input type="text" name="a" class="ip"><br></td></tr>
        <tr><td>Jenis Denda</td> <td><input type="text" name="b" class="ip" ><br></td></tr>
		...
		<td><a href="denda.php"><input type="button" name="" value="Kembali" style="width: 70px; height: 30px;"></a></td></tr>
	</table>
	</form>
	<?php
include "koneksi.php";
